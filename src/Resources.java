...
public class Resources {
	...
	public final static ImageIcon FOX_VERTICAL = resize(new ImageIcon("resources//foxVertical.png"));
	public final static ImageIcon FOX_HORIZONTAL = resize(new ImageIcon("resources//foxHorizontal.png"));
