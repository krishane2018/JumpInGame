...
public class Board {
	...
	/**
	 * Create the GUI for the board based on the initial positions of each object
	 * for the current level
	 * 
	 * @param view  - The object that contains all of the GUI configuration
	 * @param model - The object that takes care setting up the game and has the
	...
	/**
	 * Resets the gameboard view by setting all the icons to either green circles or
	 * holes
	 * 
	 * @param view
	 */
	...
	/**
	 * Creates empty gameboard for the creator view
	 * 
	 * @param view
	 */
	public static void createEmpty(CreatorView view) {
		GameButton[][] g = view.getButtons();
		for (GameButton[] b2 : g) {
			for (GameButton b1 : b2) {
				b1.setIcon(Resources.GREEN_CIRCLE);
	...
	/**
	 * Private helper function used to go through each mushroom and rabbit image and
	 * initialize board piece with each icon in the given list. If a the list has
	 * more than one image, it will iterate through each image making sure the type
	 * of image is evenly distributed. For example, if there are 3 rabbits - this
	 * will go through each image and make sure each rabbit is different.
	 * 
	 * @param gameObjects  - The icon images used for regular rabbits and mushrooms
	 * @param gameObjects2 - The icon images used for when rabbits are in holes or
	 *                     mushrooms are in holes
	 * @param positions    - The positions of where each type of object goes
	 * @param g            - The Game Buttons used in the GUI which will be updated
	...
	/**
	 * Private helper function to iterate through the positions of the foxes in the
	 * level and initializing it to a certain image depending on whether the fox at
	 * that certain point is vertical or horizontal.
	 * 
	 * @param hash - hashmap of coordinates of the fox and whether or not they are
	 *             vertical or horizontal
	 * @param g    - The Game Buttons used in the GUI which will be updated with the
	 *             right images
	 * @return the updated game buttons with the right images on them
	 */
	...
	/**
	 * private helper function to reduce repetition of setting the icon of a button
	 * at a specific location
	 * 
	 * @param icon The image the user would like to set the button to
	 * @param g    - the game buttons used in the GUI
	 * @param p    - the coordinate of which button the user would like to update
